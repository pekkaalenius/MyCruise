...
def mycruise_leaflet_map(filename):
    # ==================================
    acruise = mycruisefile(filename)

    [lo1, la1, lo2, la2] = acruise.get_boundingbox()

    tmpl = mycruise_html_tmpl
...
class mycruisefile:
    ...
    def read(self):
        # read the mcx-file or mkx-file 
        self.mcx = 'MCX' in self.fname.upper()
        self.mkx = 'MKX' in self.fname.upper()
    ...
    def leaflethtml(self):
        ...
        llhtml = mycruise_html_tmpl.copy()
