...
class MCXfile:
    ...
    def save(self, **kwargs):
        ...
        ncruise = ET.Element('cruise', name=self.name, nameEN=self.name_en, organiser=self.organiser, \
            ...
            planDateTime=self.plan_datetime, language=self.plan_language)
    #    ncruise.append(ET.Comment('Generated by mcxFile Python version'))

        ET.SubElement(ncruise, "software", version="mcxFile 2021-09-16")
